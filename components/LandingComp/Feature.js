  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
      ...
      <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
        ...
        <p class="leading-relaxed text-base">The first feature is a collaboration tool designed to facilitate engagement in ad hoc projects. This tool allows employees to contribute to smaller tasks outside their main responsibilities, fostering a collaborative culture within the company. It also maintains validated records of these contributions, recognized by both managers and peers. This not only encourages a more cohesive work environment but also ensures that no effort goes unnoticed.
</p>
    ...
    <div class="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
     ...
     {/* <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
        ...
        <p class="leading-relaxed text-base">Feature 3 info</p>
        <a class="mt-3 text-blue-500 inline-flex items-center">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
    ...
    {/*<button class="flex mx-auto mt-20 text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Add to Slack</button>
    <button class="flex mx-auto mt-20 text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Add to Teams</button>*/}
  </div>
  </div>
</section>
